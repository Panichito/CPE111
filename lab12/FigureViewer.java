 ...
 *  Modified by Panithi Suwanno (Big) 63070503426 - Added a drawRectangle
 */
import javax.swing.*;
...
public class FigureViewer extends JFrame 
	implements ActionListener
   {
	   ...
	   /** 
		* Display a Rectangle on the drawing canvas
	   ...
	   public void drawRectangle(MyRectangle figure)
	   {
		   ...
		   /* label in the center */
		   graphics.setColor(Color.BLACK);
		   graphics.drawString(new String(" " + counter),(x1 + x2)/2, (y1 + y2)/2); 
	   }
   }
