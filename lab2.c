/*  newBubble.c
 *
 *  stringBubble.c (412.21 micorseconds)
 *  newBubble.c (214.29 microseconds)
 *  This lab is intended to give you practice analyzing the impact of using different data structures for the same problem
 *  Created By Panithi Suwano 63070503426 (Big)
 *  26 JAN 2021 3.03 PM - Lab2
 */
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
...
int main(int argc, char* argv[])
{
	...
	fprintf(stdout,"Sorting %ld items required %ld microseconds\n",count,interval);
